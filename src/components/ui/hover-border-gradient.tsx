...
export function HoverBorderGradient<T extends React.ElementType = "button">({
  ...
  return React.createElement(
    Tag as React.ElementType,
    {
      ...
      className: cn(
        "relative flex border content-center bg-black/20 hover:bg-black/10 transition duration-500 dark:bg-white/20 items-center flex-col gap-10 justify-center overflow-visible p-px w-fit",
        containerClassName
      ),
      ...props,
    },
